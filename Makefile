...
DIST_SUBDIRS = mfstests mfsdata mfsmanpages mfsmaster mfsmetatools \
	mfsmetalogger mfschunkserver mfsclient mfsscripts mfsnetdump \
	systemd
...
ACLOCAL = ${SHELL} '/workspace/moosefs/build-aux/missing' aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = ar
AUTOCONF = ${SHELL} '/workspace/moosefs/build-aux/missing' autoconf
AUTOHEADER = ${SHELL} '/workspace/moosefs/build-aux/missing' autoheader
AUTOMAKE = ${SHELL} '/workspace/moosefs/build-aux/missing' automake-1.16
AWK = mawk
...
LTLIBOBJS = 
LT_SYS_LIBRARY_PATH = 
MAKEINFO = ${SHELL} '/workspace/moosefs/build-aux/missing' makeinfo
MANIFEST_TOOL = :
MATH_LIBS = -lm
...
PACKAGE_NAME = MFS
PACKAGE_STRING = MFS 4.57.1
PACKAGE_TARNAME = moosefs
PACKAGE_URL = 
PACKAGE_VERSION = 4.57.1
PATH_SEPARATOR = :
PCAP_LIBS = 
...
VERSION = 4.57.1
ZLIB_LIBS = -lz
abs_builddir = /workspace/moosefs
abs_srcdir = /workspace/moosefs
abs_top_builddir = /workspace/moosefs
abs_top_srcdir = /workspace/moosefs
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /workspace/moosefs/build-aux/install-sh
